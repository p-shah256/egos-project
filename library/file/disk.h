...
#define SYS_NET_EXEC_START    GRASS_EXEC_START + GRASS_EXEC_SEGMENT * 4
#define SYS_SHELL_EXEC_START  GRASS_EXEC_START + GRASS_EXEC_SEGMENT * 5
...
#define RWFS_SIZE              BLOCK_SIZE * 2048
