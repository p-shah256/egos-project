...
static const char *hello_response = "HTTP/1.0 200 OK\r\n"
                                    ...
                                    "    overflow: hidden;\n"
                                    "    width: 60ch;\n"
                                    "    animation: typewriter 6s steps(320);\n"
                                    "  }\n"
                                    ...
                                    "<body>\n"
                                    "<pre class=\"type\">\n"
                                    "[WARN] Humor module unstable, proceeding anyway.\n"
                                    "\n"
                                    ...
                                    "      \\/_____/   \\/_____/   \\/_____/   \\/_____/\n"
                                    "\n"
                                    "[OK] EGOS ONLINE. ALL SYSTEMS NOMINAL.\n"
                                    "\n"
                                    "Custom OS running on QEMU + SiFive FU540-C000\n"
                                    "Final project for CS 6640 - Prof. Cheng Tan\n"
