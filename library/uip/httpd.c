...
static const char *hello_response = "HTTP/1.0 200 OK\r\n"
                                    ...
                                    "</code>\n"
                                    "</pre>\n"
                                    "<h1 class=\"glow\">EGOS is ALIVE! First contact established!</h1>\n"
                                    "<h2>EGOS is a custom OS - running via QEMU on SiFive FU540-C000</h2>\n"
                                    "<h3>This is the final project for CS 6640 class with Prof. Cheng Tan</h3>\n"
                                    "<p>This is a simple HTTP server running on EGOS. </p>\n"
                                    "<p>Authors: Pranchal Shah and Vasu Kalariya</p>\n"
                                    "</center>"
                                    "</body>\n"
                                    "</html>\n";
